...
public class MockContext {
    ...
    public Optional<Matcher> getPrimitiveMatcher(MockInvocationParameter matcherParameter) {
        return matchers.stream().filter(m -> m.matches(matcherParameter)).map(rm -> rm.matcher).findFirst();
    }
